...
for t in range(num_rounds):
    ...
    reg,reward,avg_array,all_rewards_sum,all_rewards_diag = get_regret(deployments_1,fin_prompt,task,selected,avg_array,t,all_rewards_sum,all_rewards_diag,labels,"telecom")
    rewards += int(reward)
...
import pickle
with open("regrets_seqgpt_tele_5_250.pkl", "wb") as file:
    pickle.dump(regrets, file)
with open("rewards_seqgpt_tele_5_250.pkl", "wb") as file:
    pickle.dump(rewards_list, file)
with open("arm_plays_seqgpt_tele_5_250.pkl", "wb") as file:
    pickle.dump(list(plays_no), file)
with open("avg_array_acc_llms_5_tele.pkl", "wb") as file:
