...
import pickle
pickle.dump(regrets_mean, open("regrets_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(regrets_std,  open("regrets_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(rewards_mean, open("rewards_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(rewards_std,  open("rewards_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(costs_mean,   open("costs_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(costs_std,    open("costs_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(costs_summarizer_mean,   open("costs_summarizer_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(costs_summarizer_std,    open("costs_summarizer_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(plays_mean,   open("plays_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(plays_std,    open("plays_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(avg_mean,     open("avg_accuracy_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(avg_std,      open("avg_accuracy_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(summary_mean,     open("sum_avg_accuracy_mean_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(summary_std,      open("sum_avg_accuracy_std_med_budgeted_neucb_2.pkl","wb"))
pickle.dump(avg_error,      open("avg_cost_err_med_budgeted_neucb_2.pkl","wb"))
